...
{	
	...
	public function test_build_from_nice_query()
	{
		...
		$this->assertContains( "/controller/method/param1/value1/something_id/the_value", 
	...
	{
		$this->assertEquals( "http://test.host:1271/c/a/id/i",
	...
	{
		$this->assertEquals( 'https://test.host/c/a/id/i',
	...
	{
		$this->assertEquals( 'http://test.host/c/a/id/i#anchor',
	...
	public function test_to_str()
	{
		...
		$this->assertEquals( 'http://, test.host, /, hi, bye, a:0:{}',
